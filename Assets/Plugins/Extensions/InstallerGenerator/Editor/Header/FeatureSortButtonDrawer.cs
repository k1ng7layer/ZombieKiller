...
namespace Plugins.Extensions.InstallerGenerator.Editor.Header
{
	public class FeatureSortButtonDrawer : ASortButtonDrawer
	{
		...
		public FeatureSortButtonDrawer(
			...
			IEnumerable<AttributeRecord> attributes
	...
	{
		private static readonly Vector2 WindowSize = new Vector2(190, 200);

		private readonly List<FeatureToggle> _features = new List<FeatureToggle>();
