...
namespace CleverCrow.Fluid.BTs.Trees
{
	public class BehaviorTreeBuilder
	{
		...
		public BehaviorTreeBuilder AsyncParallel(string name = "asyncparallel")
		{
			return ParentTask<AsyncParallel>(name);
		}
		...
		public BehaviorTreeBuilder Condition(string name, Func<bool> action, Action onInit)
		{
			return AddNode(new ConditionGeneric
			{
				Name = name,
