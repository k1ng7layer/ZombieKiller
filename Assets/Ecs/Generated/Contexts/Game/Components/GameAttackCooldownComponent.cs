...
{
	public Ecs.Game.Components.Camera.AttackCooldownComponent AttackCooldown { get { return (Ecs.Game.Components.Camera.AttackCooldownComponent)GetComponent(GameComponentsLookup.AttackCooldown); } }
	...
	public void AddAttackCooldown(float newValue)
	{
		...
		var component = (Ecs.Game.Components.Camera.AttackCooldownComponent)CreateComponent(index, typeof(Ecs.Game.Components.Camera.AttackCooldownComponent));
	...
	public void CopyAttackCooldownTo(Ecs.Game.Components.Camera.AttackCooldownComponent copyComponent)
	{
		var index = GameComponentsLookup.AttackCooldown;
		var component = (Ecs.Game.Components.Camera.AttackCooldownComponent)CreateComponent(index, typeof(Ecs.Game.Components.Camera.AttackCooldownComponent));
		#if !ENTITAS_REDUX_NO_IMPL
