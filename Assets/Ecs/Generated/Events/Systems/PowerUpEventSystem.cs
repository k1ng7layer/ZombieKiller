...
public sealed class PowerUpEventSystem : JCMG.EntitasRedux.ReactiveSystem<PowerUpEntity>
{

	public PowerUpEventSystem(IContext<PowerUpEntity> context) : base(context)
	{
	}
	...
	{
		return entity.HasPowerUp && entity.HasPowerUpListener;
	}
	...
	protected override void Execute(System.Collections.Generic.IEnumerable<PowerUpEntity> entities)
	{
		foreach (var e in entities)
		{
			...
			e.PowerUpListener.Invoke(e, component.Id);
		}
	}
}
